...
public class Subscriber {
    ...
    public void init() {
        if (allSubscriberInfo.size() < getInputFieldsAmount()) {
            throw new IncompliteFormDataException("Not enough info obtained from the form");
        }
        int counter = 0;
    ...
    private int getInputFieldsAmount() {
        return Subscriber.class.getDeclaredFields().length - 4; //all fields - autogenerated ones
    }
